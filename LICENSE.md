...
Required Notice: Copyright Graphite Atlas (graphiteatlas.com)
...
You may begin using the software to compete with a product or service that the licensor or any of its affiliates has stopped providing, unless the licensor includes a plain-text line beginning with `Discontinued Product:` naming the product with the software. In that case, you may not use the software to compete with any discontinued product named that way.
